            ...
            >
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {todo.ai_suggestions && (
                    <div className="flex items-center gap-2 text-xs text-slate-400 mb-2">
                      ...
                      <span>
                        AI Score: {(todo.ai_priority_score * 100).toFixed(0)}%
                      </span>
                ...
                <div className="flex items-center gap-1">
                  <Dialog
                    open={isDialogOpen && selectedTodo?.id === todo.id}
                            ...
                            <div>
                              ...
                              <div className="bg-slate-700/50 p-3 rounded-lg text-sm text-slate-300">
                                ...
                                <p>
                                  Priority Score:{" "}
                                  {(
                                    selectedTodo.ai_priority_score * 100
                                  ).toFixed(0)}
                                  %
                                </p>
                                {selectedTodo.estimated_duration && (
                                  <p>
                                    Estimated Duration:{" "}
                                    {selectedTodo.estimated_duration} minutes
                                  </p>
                                )}
                              </div>
                            </div>
